...
//	* PDF/A-1b support
//============================================================+
namespace PersianPdf\src\library;

use PersianPdf\src\includes\TCPDF_COLORS;
use PersianPdf\src\includes\TCPDF_FONT_DATA;
use PersianPdf\src\includes\TCPDF_FONTS;
use PersianPdf\src\includes\TCPDF_IMAGES;
use PersianPdf\src\includes\TCPDF_STATIC;
 ...
 */
// TCPDF configuration
require_once(dirname(__DIR__).'/config/tcpdf_autoconfig.php');
//// TCPDF static font methods and data
//require_once(dirname(__DIR__) . '/includes/TCPDF_FONT_DATA.php');
//// TCPDF static font methods and data
//require_once(dirname(__DIR__) . '/includes/TCPDF_FONTS.php');
//// TCPDF static color methods and data
//require_once(dirname(__DIR__) . '/includes/TCPDF_COLORS.php');
//// TCPDF static image methods and data
//require_once(dirname(__DIR__) . '/includes/TCPDF_IMAGES.php');
//// TCPDF static methods and data
//require_once(dirname(__DIR__) . '/includes/TCPDF_STATIC.php');
...
class TCPDF {
	 ...
	 * The definition file (and the font file itself when embedding) must be present either in the current directory or in the one indicated by K_PATH_FONTS if the constant is defined. If it could not be found, the error "Could not includes font definition file" is generated.
	 ...
	 * @param $extracerts (string) specifies the name of a file containing a bunch of extra certificates to includes in the signature which can for example be used to help the recipient to verify the certificate that you used.
